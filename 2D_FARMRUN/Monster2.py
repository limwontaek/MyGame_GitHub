...
class Monster2:
    ...
    def __init__(self):
        self.image = load_image('Resource\\Monster2.png')
        self.collide_image = load_image("Resource\\collide2.png")
        self.frame = 0
    ...
    def update(self, frame_time):
        self.total_frame += Monster2.FRAMES_PER_ACTION * Monster2.ACTION_PER_TIME* frame_time
