...
class Monster3:
    ...
    def __init__(self):
        self.image = load_image('Resource\\Monster3.png')
        self.collide_image = load_image("Resource\\collide3.png")
        self.frame = 0
    ...
    def update(self, frame_time):
        self.total_frame += Monster3.FRAMES_PER_ACTION * Monster3.ACTION_PER_TIME* frame_time
